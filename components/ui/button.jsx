...
const buttonVariants = cva(
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        // adapt to dark gradient background: soft translucent fills
        primary: 'bg-white/6 text-white hover:bg-white/10 data-[state=open]:bg-white/12',
        mono: 'bg-zinc-900/60 text-white dark:bg-zinc-300 dark:text-black hover:bg-zinc-900/70 dark:hover:bg-zinc-300/90 data-[state=open]:bg-zinc-900/70',
        destructive: 'bg-red-600/80 text-white hover:bg-red-700/90 data-[state=open]:bg-red-700/90',
        secondary: 'bg-white/4 text-white/90 hover:bg-white/8 data-[state=open]:bg-white/8',
        outline: 'bg-transparent text-white border border-white/10 hover:bg-white/4 data-[state=open]:bg-white/6',
        dashed:
          'text-accent-foreground border border-input border-dashed bg-background hover:bg-accent hover:text-accent-foreground data-[state=open]:text-accent-foreground',
        ghost:
          'text-white/90 hover:bg-white/3 hover:text-white data-[state=open]:bg-white/4 data-[state=open]:text-white',
